...
module.exports = {
	...
	types: [
		...
		{ value: 'refactor', name: '♻️refactor: 重构（非feat、非fix）' },
		{ value: ':recycle: perf', name: '⚡️perf: 提高性能' },
		{ value: ':green_heart: ci', name: '💚ci: 持续集成的配置文件或脚本的修改' },
		{ value: ':construction_worker: build', name: '👷build: 构建工具或外部依赖包的修改' },
		{ value: ':seedling: WIP', name: '🌱WIP: 进行中的工作' },
		{ value: ':rewind: revert', name: '⏪️revert: 撤销某次提交' },
		{ value: ':test_tube: test', name: '🧪test: 添加缺少的测试' },
		{
			value: ':dizzy: chore',
